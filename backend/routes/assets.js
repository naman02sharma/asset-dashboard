...
router.post('/import', asyncHandler(importAssets));
...
router.patch('/:id', asyncHandler(updateAsset));
router.patch('/:id/approve', requireAdminOrSenior, asyncHandler(approveAsset));
...
router.patch('/:id/status', asyncHandler(setAssetStatus));
